...
endpoints.post('/register', function _callee(req, res) {
  var user, savedUser;
      ...
      switch (_context.prev = _context.next) {
        case 0:
          ...
          user = new User({
            ...
            email: req.body.email // diet: req.body.diet,
...
endpoints.get('/users', function _callee2(req, res) {
  var users;
...
endpoints.get('/users/:id', function _callee3(req, res) {
  var user;
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 11:
          ...
          console.error('Error fetching unique user: ', _context3.t0);
          res.status(500).json({
            error: 'users - Internal Server Error'
          });
...
endpoints.post("/users/register", function _callee4(req, res) {
  var user, savedUser;
...
endpoints["delete"]("/users/:id", function _callee5(req, res) {
  var deletedUser;
    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 14:
          ...
          console.error('Error updating favorites: ', _context8.t0);
          res.status(500).json({
            error: 'Internal Server Error'
          });
...
endpoints.get('/ingredients', function _callee9(req, res) {
  var ingredients;
    ...
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 7:
          ...
          console.error('Error fetching ingredients:', _context9.t0);
          res.status(500).json({
...
endpoints.get('/restrictions', function _callee10(req, res) {
  var restrictions;
    ...
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 7:
          ...
          console.error('Error fetching restrictions:', _context10.t0);
          res.status(500).json({
...
endpoints.get('/search-simply-recipes/:searchQuery', function _callee11(req, res) {
  var searchQuery, url;
...
endpoints.post("/search-input", function _callee12(req, res) {
  ...
  return regeneratorRuntime.async(function _callee12$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 3:
          savedRecipeInput = _context12.sent;
...
endpoints.get("/restriction-input", function _callee13(req, res) {
  ...
  return regeneratorRuntime.async(function _callee13$(_context13) {
    while (1) {
      switch (_context13.prev = _context13.next) {
        ...
        case 3:
          restrictionInputs = _context13.sent;
        ...
        case 7:
          ...
          console.error('Error fetching search input:', _context13.t0);
          res.status(500).json({
...
endpoints.post("/restriction-input", function _callee14(req, res) {
  ...
  return regeneratorRuntime.async(function _callee14$(_context14) {
    while (1) {
      switch (_context14.prev = _context14.next) {
        ...
        case 3:
          savedRestrictionInput = _context14.sent;
...
endpoints.get('/edamam', function _callee15(req, res) {
  var edamamLink;
...
endpoints.get('/scrape-recipe', function _callee16(req, res) {
...
function determineSite(link, source) {
  ...
  return regeneratorRuntime.async(function determineSite$(_context17) {
    while (1) {
      switch (_context17.prev = _context17.next) {
        case 0:
          ...
          data = [];
          _context17.prev = 3;
          _context17.t0 = source.toLowerCase().trim();
          _context17.next = _context17.t0 === 'food52' ? 7 : _context17.t0 === 'simply recipes' ? 10 : _context17.t0 === 'bbc good food' ? 13 : _context17.t0 === 'martha stewart' ? 16 : _context17.t0 === 'food network' ? 19 : _context17.t0 === 'delish' ? 22 : _context17.t0 === 'eatingwell' ? 25 : 28;
          break;
        ...
        case 35:
          ...
          console.error("Error in determineSite:", _context17.t1);
          throw _context17.t1;
...
function getRecipeDirectionsFromSource(link, scraper, findScraper) {
  ...
  return regeneratorRuntime.async(function getRecipeDirectionsFromSource$(_context18) {
    while (1) {
      switch (_context18.prev = _context18.next) {
        ...
        case 4:
          ...
          return _context18.abrupt("return", recipeDirections);

        case 13:
          _context18.prev = 13;
          _context18.t0 = _context18["catch"](1);
          console.error("Error in scraping recipe directions: ".concat(_context18.t0));
          throw _context18.t0;
