...
endpoints["delete"]("/users/:id", function _callee3(req, res) {
  var deletedUser;
...
endpoints.put('/users/:id/diet', function _callee4(req, res) {
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 16:
          ...
          console.error('Error updating diet: ', _context4.t0);
          res.status(500).json({
...
endpoints.put('/users/:id/health', function _callee5(req, res) {
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 14:
          ...
          console.error('Error updating health: ', _context5.t0);
          res.status(500).json({
            error: 'Internal Server Error'
          });
...
endpoints.put('/users/:id/favorites', function _callee6(req, res) {
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 14:
          ...
          console.error('Error updating favorites: ', _context6.t0);
          res.status(500).json({
            error: 'Internal Server Error'
          });
...
endpoints.get('/ingredients', function _callee7(req, res) {
  var ingredients;
    ...
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 7:
          ...
          console.error('Error fetching ingredients:', _context7.t0);
          res.status(500).json({
...
endpoints.get('/restrictions', function _callee8(req, res) {
  var restrictions;
    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 7:
          ...
          console.error('Error fetching restrictions:', _context8.t0);
          res.status(500).json({
...
endpoints.get('/search-simply-recipes/:searchQuery', function _callee9(req, res) {
  var searchQuery, url;
...
endpoints.post("/search-input", function _callee10(req, res) {
  ...
  return regeneratorRuntime.async(function _callee10$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 3:
          savedRecipeInput = _context10.sent;
...
endpoints.get("/restriction-input", function _callee11(req, res) {
  ...
  return regeneratorRuntime.async(function _callee11$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 3:
          restrictionInputs = _context11.sent;
        ...
        case 7:
          ...
          console.error('Error fetching search input:', _context11.t0);
          res.status(500).json({
...
endpoints.post("/restriction-input", function _callee12(req, res) {
  ...
  return regeneratorRuntime.async(function _callee12$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 3:
          savedRestrictionInput = _context12.sent;
...
endpoints.get('/edamam', function _callee13(req, res) {
  var edamamLink;
...
endpoints.get('/scrape-recipe', function _callee14(req, res) {
...
function determineSite(link, source) {
  ...
  return regeneratorRuntime.async(function determineSite$(_context15) {
    while (1) {
      switch (_context15.prev = _context15.next) {
        case 0:
          ...
          data = [];
          _context15.prev = 3;
          _context15.t0 = source.toLowerCase().trim();
          _context15.next = _context15.t0 === 'food52' ? 7 : _context15.t0 === 'simply recipes' ? 10 : _context15.t0 === 'bbc good food' ? 13 : _context15.t0 === 'martha stewart' ? 16 : _context15.t0 === 'food network' ? 19 : _context15.t0 === 'delish' ? 22 : _context15.t0 === 'eatingwell' ? 25 : 28;
          break;
        ...
        case 35:
          ...
          console.error("Error in determineSite:", _context15.t1);
          throw _context15.t1;
...
function getRecipeDirectionsFromSource(link, scraper, findScraper) {
  ...
  return regeneratorRuntime.async(function getRecipeDirectionsFromSource$(_context16) {
    while (1) {
      switch (_context16.prev = _context16.next) {
        ...
        case 4:
          ...
          return _context16.abrupt("return", recipeDirections);

        case 13:
          _context16.prev = 13;
          _context16.t0 = _context16["catch"](1);
          console.error("Error in scraping recipe directions: ".concat(_context16.t0));
          throw _context16.t0;
