...
describe('#resendVerificationCode() endpoint', () => {
  it('mocked resend verification code New User - successful', async () => {
  ...
  it('mocked resend verification code New User - unsuccessful empty full name', async () => {
    ...
    expect(fetch).not.toHaveBeenCalledWith('http://localhost:8080/api/v1/users/resendVerificationCode', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  it('mocked resend verification code New User - unsuccessful empty username', async () => {
  ...
  it('mocked resend verification code New User - unsuccessful empty email', async () => {
    global.loginHandler2.isInputEmpty = jest.fn().mockReturnValueOnce(false).mockReturnValueOnce(false).mockReturnValueOnce(true);
    const updatedDataResponse = { acknowledge: true, matchedCount: 1, modifiedCount: 1, upsertedCount: 0, upsertedId: null };
  ...
  it('mocked resend verification code New User - unsuccessful API response', async () => {
    const updatedDataResponse = { acknowledge: true, matchedCount: 1, modifiedCount: 1, upsertedCount: 0, upsertedId: null };
    ...
    global.fetch = jest.fn().mockImplementationOnce(() =>
      Promise.resolve({
        status: 404,
        json: () => Promise.reject(new Error('Code not resend code')),
      })
    )
    ...
    global.emailjs.send = jest.fn().mockImplementation(() =>
      Promise.resolve({
        status: 200,
        json: () => Promise.resolve('email sent'),
      }));
    global.loginHandler2.getVerificationCode = jest.fn(() => "33333");
    global.verificationCode = "33333";
  ...
  it('mocked resend verification code Login - successful', async () => {
    const updatedDataResponse = { acknowledge: true, matchedCount: 1, modifiedCount: 1, upsertedCount: 0, upsertedId: null };
  ...
  it('mocked resend verification code Login - unsuccessful empty username', async () => {
    global.loginHandler2.isInputEmpty = jest.fn().mockReturnValueOnce(true);
    const updatedDataResponse = { acknowledge: true, matchedCount: 1, modifiedCount: 1, upsertedCount: 0, upsertedId: null };
  ...
  it('mocked resend verification code Login - unsuccessful API call', async () => {
    const updatedDataResponse = { acknowledge: true, matchedCount: 1, modifiedCount: 1, upsertedCount: 0, upsertedId: null };
...
describe('#verify() endpoint', () => {
  ...
  it('mocked update verification status Login - unsuccessful empty code', async () => {
    ...
    expect(response).toBe(false);
    expect(fetch).toHaveBeenCalledTimes(0);
    expect(fetch).not.toHaveBeenCalledWith('http://localhost:8080/api/v1/users/verify', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  it('mocked update verification status New User - unsuccesful empty code', async () => {
    global.loginHandler2.isInputEmpty = jest.fn().mockReturnValueOnce(true);
    const updatedDataResponse = { acknowledge: true, matchedCount: 1, modifiedCount: 1, upsertedCount: 0, upsertedId: null };
  ...
  it('mocked update verification status New User - unsuccesful empty username', async () => {
    global.loginHandler2.isInputEmpty = jest.fn().mockReturnValueOnce(false).mockReturnValueOnce(true);
    const updatedDataResponse = { acknowledge: true, matchedCount: 1, modifiedCount: 1, upsertedCount: 0, upsertedId: null };
  ...
  it('mocked update verification status New User - unsuccesful empty full name', async () => {
    global.loginHandler2.isInputEmpty = jest.fn().mockReturnValueOnce(false).mockReturnValueOnce(false).mockReturnValueOnce(true);
    const updatedDataResponse = { acknowledge: true, matchedCount: 1, modifiedCount: 1, upsertedCount: 0, upsertedId: null };
